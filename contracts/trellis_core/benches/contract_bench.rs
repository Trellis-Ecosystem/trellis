...
fn bench_init_1_milestone() {
    ...
    println!(r#"{{"benchmark":"init_1_milestone","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#);
}
...
fn bench_init_10_milestones() {
    ...
    println!(
        r#"{{"benchmark":"init_10_milestones","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#
    );
}
...
fn bench_lock_funds() {
    ...
    println!(r#"{{"benchmark":"lock_funds","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#);
}
...
fn bench_submit_work() {
    ...
    println!(r#"{{"benchmark":"submit_work","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#);
}
...
fn bench_approve_and_release() {
    ...
    println!(
        r#"{{"benchmark":"approve_and_release","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#
    );
}
...
fn bench_raise_dispute() {
    ...
    println!(r#"{{"benchmark":"raise_dispute","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#);
}
...
fn bench_resolve_dispute() {
    ...
    println!(r#"{{"benchmark":"resolve_dispute","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#);
}
...
fn bench_batch_lock_funds() {
    ...
    println!(
        r#"{{"benchmark":"batch_lock_funds_5","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#
    );
}
...
fn bench_get_agreement() {
    ...
    println!(r#"{{"benchmark":"get_agreement","cpu_instructions":{cpu},"memory_bytes":{mem}}}"#);
}
